...
class QuizPage extends StatelessWidget {
  ...
  QuizPage({Key key, @required this.timevalue, this.randomvalue, this.questionvalue}) : super(key: key);
  @override
  Widget build(BuildContext context) {
    ...
    return FutureBuilder(
      future:
          DefaultAssetBundle.of(context).loadString("assets/examplecsvjson.json", cache: false),
      builder: (context, snapshot) {
        ...
        if (mydata == null) {
          ...
          return quizpage(mydata: mydata, timevalue:timevalue, randomvalue: randomvalue, questionvalue: questionvalue);
        }
      },
    );
  }
...
class quizpage extends StatefulWidget {
  ...
  quizpage({Key key, @required this.mydata, this.timevalue, this.randomvalue, this.questionvalue}) : super(key: key);
  @override
  _quizpageState createState() => _quizpageState(mydata, timevalue, randomvalue, questionvalue);
}
...
class _quizpageState extends State<quizpage> {
  ...
  final String randomvalue;
  final String questionvalue;
  _quizpageState(this.mydata, this.timevalue, this.randomvalue, this.questionvalue);
